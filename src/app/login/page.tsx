    ...
    <div className="mx-auto my-12 max-w-md px-4">
      <Card className="rounded-2xl border border-neutral-200 bg-white p-8 shadow-lg">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-neutral-900">Entrar na sua conta</h1>
          <p className="text-sm text-neutral-500 mt-1">Insira suas credenciais para continuar.</p>
        </div>
